      ...
      <nav className={`navbar ${hidden ? "navbar-hidden" : ""}`} role="navigation" aria-label="Main">
        <div className="nav-inner">
          <Link to="/" className="brand" onClick={handleLinkClick} aria-label="Home">
            <img className="brand-logo" src="/Images/main-logo.png" alt="Logo" />
          </Link>
          ...
          <div className="nav-links desktop-only">
            {links.map((it) => (
              <Link
                ...
                className={`nav-btn ${isActive(it.path) ? "active" : ""}`}
              >
                <span className="nav-btn-inner">
                  <span className="nav-btn-dots" aria-hidden="true" />
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="nav-sparkle" aria-hidden="true">
                    <path
                      className="nav-path"
                  ...
                  <span className="nav-btn-text">{it.name}</span>
                </span>
              </Link>
            ))}
          </div>
        ...
        <div className="mobile-links">
          {links.map((it) => (
            <Link
              ...
              to={it.path}
              onClick={handleLinkClick}
              className={`mobile-btn ${isActive(it.path) ? "active" : ""}`}
            >
              <span className="nav-btn-inner">
                <span className="nav-btn-dots" aria-hidden="true" />
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="nav-sparkle" aria-hidden="true">
